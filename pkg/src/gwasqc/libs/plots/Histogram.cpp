...
//double Histogram::pretty0(double *lo, double *up, int *ndiv, int min_n, double shrink_sml, double high_u_fact[], int eps_correction, int return_bounds) {
...
//
//    if(cell < 20*DBL_MIN) {
//      /* DT commented: warning(_("Internal(pretty()): very small range.. corrected")); */
//      cell = 20*DBL_MIN;
//    } else if(cell * 10 > DBL_MAX) {
//      /* DT commented: warning(_("Internal(pretty()): very large range.. corrected")); */
//      cell = .1*DBL_MAX;
//    }

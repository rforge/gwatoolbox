...
#include "include/SamplerException.h"

const int SamplerException::MESSAGE_TEMPLATES_NUMBER = 24;
const char* SamplerException::MESSAGE_TEMPLATES[] = {
...
/*10*/	"Error while parsing '%s' value in '%s' column on line %d to a float.",
...
/*15*/	"'%s' marker ID is duplicated in '%s' file.",
...
/*23*/	"Error while sampling lines from GWAS input files."
};

SamplerException::SamplerException() : Exception() {

}

SamplerException::SamplerException(int message_template_index, ... ) : Exception()  {
	va_list arguments;
...
SamplerException::SamplerException(const char* class_name, const char* method_name, int source_line) : Exception(class_name, method_name, source_line)  {

}

SamplerException::SamplerException(const char* class_name, const char* method_name, int source_line, int message_template_index, ... ) : Exception() {
	va_list arguments;
...
SamplerException::SamplerException(const Exception& exception) : Exception(exception) {

}

SamplerException::~SamplerException() throw() {

}

const char* SamplerException::get_message_template(int message_template_index) {
